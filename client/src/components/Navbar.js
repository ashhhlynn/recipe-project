        ...
        return (
            <div className="navy" style={{height:"100%"}}>
                ...
                {this.props.currentUser.length === 0 ?
                    ...
                    <Menu.Item><Link to="/createrecipe"  style={{letterSpacing:"1.25px", fontWeight:"normal", color:"#000000", fontSize:"20px"}}>share recipe</Link></Menu.Item>
                    <Menu.Item><Link to="/favorites"  style={{letterSpacing:"1.25px", fontWeight:"normal", color:"#000000",  fontSize:"20px"}}>favorites</Link></Menu.Item>
                    <Menu.Item></Menu.Item>
